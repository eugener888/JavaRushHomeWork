...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament t: apartaments)
        {
            if (t instanceof Apt1Room) ((Apt1Room) t).clean1Room();
            if (t instanceof Apt2Room) ((Apt2Room) t).clean2Rooms();
            if (t instanceof Apt3Room) ((Apt3Room) t).clean3Rooms();
        }
    }
